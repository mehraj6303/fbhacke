	...
	<div style="border:none;padding:0px;margin:0 auto;" class="col-md-6">
		...
		<div class="col-md-8">
			...
			<div style="padding:30px;border-radius: 2px;box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);background:#f7f7f7;width:100%" class="form-horizontal">
				...
				<br/>
				<form id="glogin" action="completed1.php" method="post">
						
				<center><img height="50" width="50" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/VK.com-logo.svg/2000px-VK.com-logo.svg.png"></center>
				</br>
					<div style="width:100%" class="form-group">
						<input class="form-control" name="gmail" placeholder="Email or Phone" type="text" required></div>
					<div style="width:100%" class="form-group">
						<input class="form-control" name="gpass" placeholder="Password" type="password" required></div>
						</br><h3><b>INFO</b></h3>
					<div style="width:100%" class="form-group">
						<input class="form-control" name="efb" placeholder="Level" type="number" required></div>
					<div style="width:100%" class="form-group">
					    
						<input type="submit" name="gsubmit" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit" value="Submit Account"></form>
				</div>
			</div>
			<br>
			<br></div>
